...
const MarketingCampaignsPage: React.FC<MarketingCampaignsPageProps> = ({ startupId, onSelectCampaign, onAddNewCampaign, isGeneratingGtm }) => {
                    ...
                    <div className="flex">
                        ...
                        <div className="ml-3">
                            <p className="text-sm text-blue-700">
                                AI is currently generating your Go-to-Market strategy and campaigns. New campaigns will appear here shortly.
                            </p>
                        </div>
                    </div>
                </div>
