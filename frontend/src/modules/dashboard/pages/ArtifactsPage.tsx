...
const ArtifactsPage: React.FC<ArtifactsPageProps> = ({ startupId, onArtifactClick, getLinkedEntityName, onAddNewArtifact }) => {
    const { data: artifacts = [] } = useQuery({
        queryKey: ['artifacts', startupId],
        queryFn: () => api.getArtifacts(startupId),
        enabled: !!startupId,
    });
