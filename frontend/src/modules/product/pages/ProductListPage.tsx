...
const ProductListPage: React.FC<ProductListPageProps> = ({ startupId, onSelectProduct, onAddNewProduct, isGeneratingProduct }) => {
    const { data: products = [] } = useQuery({
        queryKey: ['products', startupId],
        queryFn: () => api.getProducts(startupId),
        enabled: !!startupId,
    });
