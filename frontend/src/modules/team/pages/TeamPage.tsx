...
import TeamManagementModal from '@/modules/team/components/TeamManagementModal';
...
const TeamPage: React.FC<TeamPageProps> = ({ startupId }) => {
    ...
    const { data: members = [], isLoading: loading } = useQuery({
        queryKey: ['teamMembers', startupId],
        queryFn: () => api.getTeamMembers(startupId),
        enabled: !!startupId,
    });

    const refreshMembers = () => {
        queryClient.invalidateQueries({ queryKey: ['teamMembers', startupId] });
    };
