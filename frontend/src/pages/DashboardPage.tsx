...
import { Scope, Startup, BusinessMonthlyData, FundingRound, Task, Experiment, Artifact, LinkedEntityType, Product, Feature, ProductMetric, ProductIssue, ExperimentStatus, Investor, MarketingCampaign, MarketingCampaignStatus, MarketingContentStatus, MarketingContentItem, Founder } from '../../dashboard/types';
