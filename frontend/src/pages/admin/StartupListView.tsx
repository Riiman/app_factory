  ...
  return (
    <div className="p-8">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-bold text-brand-text-primary">Venture Directory</h2>
      ...
      {filteredStartups.length > 0 ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left text-brand-text-secondary">
              <thead className="text-xs text-slate-500 uppercase bg-slate-50">
                <tr>
                  <th scope="col" className="px-6 py-3">Venture Name</th>
        ...
        <div className="text-center py-16">
          ...
          <h3 className="mt-4 text-lg font-semibold">No Ventures Found</h3>
          <p className="mt-1 text-sm text-brand-text-secondary">
            {searchTerm ? "Adjust your search or " : ""}
            Approve a venture from the workflow to see it here.
          </p>
        </div>
      )}
    </div>
